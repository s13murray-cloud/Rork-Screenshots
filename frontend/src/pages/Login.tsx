...
export function Login() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (!storedEmail) {
            setError('Device not registered. Please use an invitation link first.');
            return;
        }
        ...
        try {
            const data = await api.auth.login({ email: storedEmail, pin });
